...
# ********RoostGPT********
import pytest
from _exceptions import _parser_syntax_error_unpickle, ParserSyntaxError
from typing import Any, Dict

class Test_ExceptionsParserSyntaxErrorUnpickle778:
    ...
    def test_unpickle_with_valid_kwargs(self):
        kwargs: Dict[str, Any] = {
            ...
            "details": "Missing parenthesis"
        }
        obj = _parser_syntax_error_unpickle(kwargs)
        assert isinstance(obj, ParserSyntaxError)
