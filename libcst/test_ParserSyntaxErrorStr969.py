...
class Test_ParserSyntaxErrorStr969:
    @pytest.mark.smoke
    def test_str_with_context(self):
        ...
        assert str(error) == "Syntax Error @ 3:6.\nSyntax Error Message\n\nsome line"

    @pytest.mark.smoke
    def test_str_without_context(self):
        error = ParserSyntaxError("Syntax Error Message")
        assert str(error) == "Syntax Error @ None:None.\nSyntax Error Message"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "Syntax Error Message 2",
            "Syntax Error Message 3",
        ]
    )
    def test_str_with_error_inputs(self, message):
    ...
    def test_str_line_and_column(self, values):
        error = ParserSyntaxError(
            "Error", 
            lines=[values[0]], 
            raw_line=values[1], 
        ...
        assert f"Syntax Error @ {values[1]}:{values[2]}." in str(error)
