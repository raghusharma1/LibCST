...
class Test_ToolInvalidCommand393:

    @pytest.mark.parametrize(("proc_name", "command_args", "expected_output"), [
        ("", [], "Please specify a command!"),
        ("TestProc", [], "Please specify a command!"),
        ("TestProc", ["arg1", "arg2"], "Please specify a command!"),
    ])
    def test_invalid_command(self, proc_name, command_args, expected_output):
        assert _invalid_command(proc_name, command_args) == expected_output
